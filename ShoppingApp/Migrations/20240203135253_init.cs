        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdersHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdersHistoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_OrdersHistories_OrdersHistoryId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5a62b233-10b2-4e98-b3b5-f1ee4eb46c58", null, "Seller", "SELLER" },
                    { "84dd10c8-a017-43ed-8be5-f7e324df259e", null, "User", "USER" },
                    { "ff61f323-ef80-4dab-b009-9d67a3c09452", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrdersHistoryId",
                table: "Orders",
